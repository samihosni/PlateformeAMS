 ...
 */
final class Version20240124231703 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_filiere ADD CONSTRAINT FK_76DD4394A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
