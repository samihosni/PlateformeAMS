...
class ModuleController extends AbstractController
{
    ...
    #[Route('/new', name: 'app_module_new', methods: ['GET', 'POST']), IsGranted('ROLE_ADMIN')]
    ...
    #[Route('/{id}/edit', name: 'app_module_edit', methods: ['GET', 'POST']),IsGranted('ROLE_ADMIN')]
    ...
    #[Route('/{id}', name: 'app_module_delete', methods: ['POST']), IsGranted('ROLE_ADMIN')]
